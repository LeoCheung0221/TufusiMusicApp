package com.tufusi.lib_webview.activity;
...
import com.tufusi.lib_webview.adbrowser.AdBrowserLayout;
import com.tufusi.lib_webview.adbrowser.AdBrowserWebViewClient;
import com.tufusi.lib_webview.adbrowser.Base64Drawables;
import com.tufusi.lib_webview.adbrowser.BrowserWebView;
import com.tufusi.lib_webview.utils.Utils;
            ...
            public void onClick(View v) {
                ...
                if (uriString != null) {
                    ...
                    boolean isActivityResolved =
                            getPackageManager().resolveActivity(browserIntent, PackageManager.MATCH_DEFAULT_ONLY) != null ? true : false;
