package com.tufusi.lib_image_loader.app;
...
import com.tufusi.lib_image_loader.R;
import com.tufusi.lib_image_loader.image.CustomRequestListener;
import com.tufusi.lib_image_loader.utils.Utils;
 ...
 *
 * @author 鼠夏目
 * @description 图处加载类，外界唯一调用类,直持为view,notification,appwidget加载图片
 */
