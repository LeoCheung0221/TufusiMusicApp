package com.tufusi.lib_common_ui.spec;
...
import com.tufusi.lib_common_ui.R;
...
public class HorizontalItemView extends RelativeLayout {
    ...
    public HorizontalItemView(Context context, AttributeSet attrs, int defaultStyle) {
        ...
        mTipVisibility = a.getBoolean(R.styleable.HorizontalItemView_hTipVisiblity, false);
    ...
    private void createView() {
        ...
        if (mRightIcon != null) {
            ...
            rightParams.addRule(RelativeLayout.LEFT_OF, R.id.horizontal_image_id);
